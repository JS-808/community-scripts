...
USERS = [
    {
        ...
        "scripts": [
            ...
            {"name": "dBirdhouseRunner", "template": "dBirdhouseRunner/jar/dBirdhouseRunner.jar"},
            ...
            {"name": "dSpookyCollector", "template": "dSpookyCollector/jar/dSpookyCollector.jar"},
...
#        "branch": "main",
#        "scripts": [
#            {"name": "KaizoWintertodtLooter", "url": "https://github.com/KaIZOOSRS/OSMB-Projects/releases/download/re/KaizoWintertodtLooter.jar"}
#        ]
#    },
#    {
#        "display": "Ultimate",
#        "github": "ultimate-engine",
#        "repo": "OSMB-scripts",
#        "branch": "main",
#        "scripts": [
#            {"name": "Pumper", "template": "Pumper/jar/Pumper.jar"}
#        ]
#    }
]
...
class MainWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("OSMB Community Script Downloader by JS808 v3.1.2")
        self.resize(660, 500)
        self.layout = QVBoxLayout(self)
